...
import '../../controller/InformationPagesOther.dart';
import '../../controller/SignUpControler.dart';

class LoginPageSpinner extends StatefulWidget {
  const LoginPageSpinner({super.key});

  @override
  State<LoginPageSpinner> createState() => _LoginPageSpinnerState();
}

class _LoginPageSpinnerState extends State<LoginPageSpinner> {
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InformationPagess(
