...
class Textiletab extends StatefulWidget {
  const Textiletab({super.key});

  @override
  _TextiletabState createState() => _TextiletabState();
}

class _TextiletabState extends State<Textiletab> {
  final getStorge = GetStorage();
  int _currentIndex = 0;
