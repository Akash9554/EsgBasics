...
class InformationPages extends StatefulWidget {
  ...
  const InformationPages({super.key, required this.onAccept});
  @override
...
class _InformationPagesState extends State<InformationPages> {
  ...
  final List<Map<String, dynamic>> sections = [
    ...
    },
    {
      ...
      'text': [
        ' MUST AGREE to for compliance',
        '1. Do you and your employees set maternity leave, social security provisions, and non-mandatory benefits according to the most favorable conditions for the worker, whether its national laws or agreements with workers organizations?',
        '2. If equivalent benefits like pension schemes or social security cannot be provided to certain workers (e.g., migrant or temporary/seasonal), does your organization offer an alternative and equivalent benefit through other means?',
        '3. Do you and your employees maintain an up-to-date list of all employed workers, including their full names, genders, ages, nationalities, days worked, and wages paid?',
        '4. Do you and your employees set salaries according to local regulations, regional average wages, or official minimum wages for similar occupations, whichever is highest?',
        '5. For production-based, quota, and piecework during normal working hours, do you and your employees pay at least the minimum wage or the relevant industry average, whichever is higher?',
        '6. Do you and your employees make regular wage payments in legal tender at scheduled intervals?',
        '7. Do you document all payments with a pay slip or log system that includes detailed information about the work done and the payment received?',
        '8. If employing migrant or seasonal workers through a contracting agency or person, do you put measures in place to ensure their hiring and working conditions are equally applied?',
        '9. Do you and your employees ensure that all permanent workers have legally binding contracts and are aware of their rights, duties, responsibilities, salaries, and work schedules?',
        '10. Do you ensure that workers have a signed copy of their employment contract in a format and language they understand?',
        '11. Where possible, do you and your employees assign all regular work to permanent workers?',
        '12. Do you and your employees ensure that local, migrant, seasonal, and permanent workers receive the same benefits and employment conditions for the same work performed?',
